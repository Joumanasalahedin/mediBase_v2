...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['register_patient'])) {
        ...
        $register_sql = "INSERT INTO `patients` (`first_name`, `last_name`, `birthdate`, `gender`, `nationality`, `health_insurance_no`,
            ...
            VALUES ('$first_name', '$last_name', '$birthdate', '$gender', '$nationality', '$health_insurance',
...
<head>
    <meta charset="utf-8">
    <title>mediBase Portal - Patient Registration</title>
            ...
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="patients.php" class="nav-item nav-link"><i class="fa fa-hospital-user me-2"></i>My
                        Patients</a>
                    <a href="patient-registration.php" class="nav-item nav-link active"><i class="fa fa-user-plus me-2"></i>Register Patient</a>
                ...
                <div class="bg-secondary rounded h-100 p-4">
                    ...
                    <form action="<?php htmlspecialchars($_SERVER["PHP_SELF"]) ?>" method="post">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="inputEmail3" name="last_name" required>
                            </div>
                        </div>
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="inputEmail3" name="blood_group">
                            </div>
                        </div>
                        <div class="row mb-3">
